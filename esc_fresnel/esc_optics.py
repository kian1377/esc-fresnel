...
elements = {
    ...
    'pupil_mask': poppy.CircularAperture(radius=diams['pupil_mask']/2, name='Pupil Mask', planetype=pupil), 
    ...
    'scicam': poppy.ScalarTransmission(name='Scicam FP', planetype=inter),
}
