...
class single():
    ...
    def set_m4(self, tt_vals, lamD=True):
        ...
        tip_at_pupil_pv = np.tan(tt_vals[0]/self.as_per_radian) * self.esc_pupil_diam.to_value(u.m) * self.m4_pupil_ratio * 1.00044
        tilt_at_pupil_pv = np.tan(tt_vals[1]/self.as_per_radian) * self.esc_pupil_diam.to_value(u.m) * self.m4_pupil_ratio * 1.00044
    ...
    def set_fsm(self, tt_vals, lamD=True):
        ...
        tip_at_pupil_pv = np.tan(tt_vals[0]/self.as_per_radian) * self.esc_pupil_diam.to_value(u.m) * self.fsm_pupil_ratio * 1.0005
        tilt_at_pupil_pv = np.tan(tt_vals[1]/self.as_per_radian) * self.esc_pupil_diam.to_value(u.m) * self.fsm_pupil_ratio * 1.0005
